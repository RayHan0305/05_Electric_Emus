...
"""
align_seqs_faster.py
This script will align any two DNA sequences from FASTA.

Usage: 
    This script will take any two fasta sequences (in seperate file in data folder) to be aligned as input.

    Method 1:
    No parameters (automatically pick two example fasta files in data/)
    python3 align_seqs_faster.py

    Method 2:
    Explicitly specify two fasta files as input.
    python3 align_seqs_faster.py seq1.fasta seq2.fasta
"""
